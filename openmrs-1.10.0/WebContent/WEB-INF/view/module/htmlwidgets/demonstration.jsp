...
<c:forEach items="${availableProperties}" var="p">
	...
	<div id="defaultWidget${p.key}" class="defaultWidget">
		...
		<form method="get" action="demonstration.form">
			...
			<input type="checkbox" name="includeRetired" value="true"/> Include Retired<br/>
			<wgt:widget id="defaultField${p.key}" name="${p.key}" object="${demo}" property="${p.key}" attributes="includeRetired=${includeRetired}"/>
