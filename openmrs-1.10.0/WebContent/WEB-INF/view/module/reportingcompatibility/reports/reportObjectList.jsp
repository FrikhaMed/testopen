...
<h2><spring:message code="reportingcompatibility.ReportObject.manage.title"/></h2>	

<a href="reportObject.form"><spring:message code="reportingcompatibility.ReportObject.add"/></a> <br />

<br />

<b class="boxHeader"><spring:message code="reportingcompatibility.ReportObject.list.title"/></b>
...
<form method="post" class="box">
	...
	<input type="submit" value="<spring:message code="reportingcompatibility.ReportObject.delete"/>" name="action">
</form>
</c:if>
<c:if test="${reportObjectList.size == 0}">
	&nbsp;&nbsp;<spring:message code="reportingcompatibility.ReportObject.list.nonefound"/>
</c:if>
