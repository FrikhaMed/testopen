...
<h3><spring:message code="reportingcompatibility.PatientSearch.bookkeeping" /></h3>
...
<table border=0>
	...
	<c:if test="${!empty patientSearchForm.patientSearch.filterClass}">
		<tr>
			<th valign="top"><spring:message code="reportingcompatibility.PatientSearch.javaclass" /></th>
			<td valign="top">
...
<c:if test="${!empty patientSearchForm.patientSearch.arguments}">
	<h3><spring:message code="reportingcompatibility.PatientSearch.searchArguments" /></h3>
	<table border=0>
		<tr>
			<td rows="1"><b><spring:message code="general.name" /></b></td>
			<td rows="1"><b><spring:message code="reportingcompatibility.PatientSearch.value" /></b></td>
			<td rows="1"><b><spring:message code="reportingcompatibility.PatientSearch.javaclass" /></b></td>
		</tr>
...
<c:if test="${!empty patientSearchForm.patientSearch.parsedComposition}">
	<h3><spring:message code="reportingcompatibility.PatientSearch.composition" /></h3>
	<table>
		<tr>
			<td>&nbsp;</td>
			<td><a href="javascript:activateXMLEditor()"><spring:message code="reportingcompatibility.PatientSearch.advanced" /></a></td>
		</tr>
		<tr>
			<td>&nbsp;</td>
			<td>
...
<input type="submit" name="action"
	value='<spring:message code="reportingcompatibility.PatientSearch.save"/>'>
	<input type="submit" name="action"
