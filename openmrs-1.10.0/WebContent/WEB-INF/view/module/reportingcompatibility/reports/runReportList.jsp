...
<c:if test="${fn:length(reports) != 0}">
	...
	<table cellpadding="2" cellspacing="0">
		<tr>
			<th></th>
			<th style="padding-left: 3em"><spring:message code="reportingcompatibility.Report.description"/></th>
			<th style="padding-left: 3em"><spring:message code="reportingcompatibility.Report.list.lastRun"/></th>
		</tr>
